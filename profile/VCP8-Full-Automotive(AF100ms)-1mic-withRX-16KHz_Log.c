...
static vcp_profile_general_t p_gen_16k = { /*** General profile */
  ...
  0x1b26,  /*                 DATE = 0x1b26       DAYS since 1st Jan 2000 */
  0x052c,  /*                 TIME = 0x052c       MINUTES since 00:00 */
  0x1e08,  /*                  CRC = 0x1e08       CRC for all parameters [CRC is normally HEX] */
}; /**** static vcp_profile_general_t p_gen_16k */

static vcp_profile_ns2_t p_tx_ns2_16k = { /*** TX NS2 */
...
}; /**** static vcp_profile_ns2_t p_tx_ns2_16k */

static vcp_profile_eq_t p_tx_ns2_16k_snsg_eq = { /*** TX SNS EQ */
  0x0000,   /* Num entries = 0 */
  0x0000,   /*     EQ type = 0 */
  {
   0x0000, 0x0000    /*     0.00 Hz -> -72.0 dB */
  }
}; /**** static vcp_profile_eq_t p_tx_ns2_16k_snsg_eq */

static vcp_profile_eq_t p_tx_ns2_16k_bnlh_eq = { /*** TX BNLH EQ */
  0x0000,   /* Num entries = 0 */
  0x0000,   /*     EQ type = 0 */
  {
   0x0000, 0x0000    /*     0.00 Hz -> -72.0 dB */
  }
}; /**** static vcp_profile_eq_t p_tx_ns2_16k_bnlh_eq */

static vcp_profile_eq_t p_tx_ns2_16k_ming_eq = { /*** TX MING EQ */
  0x0000,   /* Num entries = 0 */
  0x0000,   /*     EQ type = 0 */
  {
   0x0000, 0x0000    /*     0.00 Hz -> -72.0 dB */
  }
}; /**** static vcp_profile_eq_t p_tx_ns2_16k_ming_eq */

static vcp_profile_eq_t p_tx_eq_16k = { /*** TX EQ */
...
}; /**** static vcp_profile_eq_t p_tx_eq_16k */

static vcp_profile_agc_t p_tx_agc_16k = { /*** TX AGC/DRC */
...
}; /**** static vcp_profile_agc_t p_tx_agc_16k */

static vcp_profile_dcr_t p_tx_dcr_16k = { /*** TX DC removal */
  0x0000,  /*           TX_DCR_BPS = Normal       TX DCR bypass modes */
  0x0032,  /*            TX_DCR_FC = 50           TX DC removal filter cut-off frequency [Hz] [int] */
}; /**** static vcp_profile_dcr_t p_tx_dcr_16k */

static vcp_profile_dcr_t p_rx_dcr_16k = { /*** RX DC removal */
  0x0000,  /*           RX_DCR_BPS = Normal       RX DCR bypass modes */
  0x0032,  /*            RX_DCR_FC = 50           RX DC removal filter cut-off freq. [Hz] [int] */
}; /**** static vcp_profile_dcr_t p_rx_dcr_16k */

static vcp_profile_ns2_t p_rx_ns2_16k = { /*** RX NS2 */
  ...
  0xffff,  /*      RX_NS2_WNR_MATT = -1           Wind noise reduction minimal attenuation [dB] [int] */
...
}; /**** static vcp_profile_ns2_t p_rx_ns2_16k */

static vcp_profile_eq_t p_rx_ns2_16k_snsg_eq = { /*** RX SNS EQ */
  0x0000,   /* Num entries = 0 */
  0x0000,   /*     EQ type = 0 */
  {
   0x0000, 0x0000    /*     0.00 Hz -> -72.0 dB */
  }
}; /**** static vcp_profile_eq_t p_rx_ns2_16k_snsg_eq */

static vcp_profile_eq_t p_rx_ns2_16k_bnlh_eq = { /*** RX BNLH EQ */
  0x0000,   /* Num entries = 0 */
  0x0000,   /*     EQ type = 0 */
  {
   0x0000, 0x0000    /*     0.00 Hz -> -72.0 dB */
  }
}; /**** static vcp_profile_eq_t p_rx_ns2_16k_bnlh_eq */

static vcp_profile_eq_t p_rx_ns2_16k_ming_eq = { /*** RX MING EQ */
  0x0000,   /* Num entries = 0 */
  0x0000,   /*     EQ type = 0 */
  {
   0x0000, 0x0000    /*     0.00 Hz -> -72.0 dB */
  }
}; /**** static vcp_profile_eq_t p_rx_ns2_16k_ming_eq */

static vcp_profile_af_t p_tx_af_16k = { /*** TX AF */
...
}; /**** static vcp_profile_af_t p_tx_af_16k */

static vcp_profile_es_t p_tx_es_16k = { /*** TX ES */
...
}; /**** static vcp_profile_es_t p_tx_es_16k */

static vcp_profile_eq_t p_rx_eq_16k = { /*** RX EQ */
  0x0004,   /* Num entries = 4 */
  0x0000,   /*     EQ type = 0 */
  {
...
}; /**** static vcp_profile_eq_t p_rx_eq_16k */

static vcp_profile_agc_t p_rx_agc_16k = { /*** RX AGC/DRC */
...
}; /**** static vcp_profile_agc_t p_rx_agc_16k */

static vcp_profile_dtgc_t p_rx_dtgc_16k = { /*** RX DTGC */
...
}; /**** static vcp_profile_dtgc_t p_rx_dtgc_16k */

static vcp_profile_debug_t p_deb_16k = { /*** Debugs */
...
}; /**** static vcp_profile_debug_t p_deb_16k */

static vcp_profile_log_t p_log_16k = { /*** Logger */
  {
...
}; /**** static vcp_profile_log_t p_log_16k */

PROFILE_TYPE(t) profile_16k = {
  &p_gen_16k,              /* General profile is always included             */
  &p_tx_ns2_16k,           /* TX NS2                                         */
  &p_tx_ns2_16k_snsg_eq,   /* TX SNS EQ                                      */
  &p_tx_ns2_16k_bnlh_eq,   /* TX BNLH EQ                                     */
  &p_tx_ns2_16k_ming_eq,   /* TX MING EQ                                     */
  0,                       /* Block [TX FS] -- IS TURNED OFF!                */
  &p_tx_eq_16k,            /* TX EQ                                          */
  &p_tx_agc_16k,           /* TX AGC/DRC                                     */
  &p_tx_dcr_16k,           /* TX DC removal                                  */
  &p_rx_dcr_16k,           /* RX DC removal                                  */
  &p_rx_ns2_16k,           /* RX NS2                                         */
  &p_rx_ns2_16k_snsg_eq,   /* RX SNS EQ                                      */
  &p_rx_ns2_16k_bnlh_eq,   /* RX BNLH EQ                                     */
  &p_rx_ns2_16k_ming_eq,   /* RX MING EQ                                     */
  ...
  &p_rx_eq_16k,            /* RX EQ                                          */
  &p_rx_agc_16k,           /* RX AGC/DRC                                     */
  &p_rx_dtgc_16k,          /* RX DTGC                                        */
...
# Informative -- DATE=2019/01/11
# Informative -- TIME=22:04
# Informative -- CRC=0x1e08
...
RX_NS2_BLOCK=On
  ...
  RX_NS2_WNR_STR=0.5000 RX_NS2_WNR_MATT=-1 RX_NS2_WNR_THR=0 RX_NS2_WNR_IT=500
